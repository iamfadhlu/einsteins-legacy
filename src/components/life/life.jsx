    ...
    return (
        ...
        <div>
            <div className="container">
                ...
                <div className="life-subheading">(Childhood,Youth and Education)</div>
                <hr classname="life-hr" />

                <br />
                <div className="container">
                    <div class="clearfix">
                        <img src={life_einstein_png} className="col-md-6 float-md-start mb-3 me-md-3  einstein_png" alt="..." />
                        <section className="life-text">
