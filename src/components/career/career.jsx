    ...
    return (
        <div>
            <div className="container">
                <hr />
                <h1 className="Header1">Early academic career (1908-1933): </h1>
                <div className="clearfix">
                    <img src={img1} id="image" className=" col-xl-6  col-md-6  col-sm-12`   float-md-start mb-3 me-md-3 " alt="" />
                ...
                <section>
                    ...
                    <h2 className="h2v">1905 – Annus Mirabilis papers</h2>
                    <div className="text">
                    ...
                    <div className="clearfix">
                        <img src={img6} id="career-image6" className="col-md-3 float-md-end mb-1 ms-md-3" alt="image" />
                    ...
                    <div className="clearfix">
                        <div className="career-text">
                            ...
                            <img src={img7} id="career-image7" className="col-md-4 float-md-end mb-1 ms-md-3" alt="image" />
                    ...
                    <div className="clearfix">
                        ...
                        <div className="career-text">
                            <img src={img8} id="career-image8" className="col-md-3 float-md-start mb-1 me-md-3" alt="image" />
                    ...
                    <div className="clearfix">
                        <div className="career-text">
                            ...
                            <img src={img9} id="career-image9" className="col-md-3 float-md-start mb-1 me-md-3" alt="image" />
                            <p>
                    ...
                    <div className="career-text">
                        ...
                        <div className="clearfix">
                            ...
                            <img src={img10} id="career-image10" className="col-md-2 float-md-start mb-1 me-md-3" alt="image" />
                    ...
                    <div className="clearfix">
                        <div className="career-text">
                            <img src={img11} id="career-image11" className="col-md-2 float-md-end mb-1 ms-md-3" alt="image" />
                            ...
                            <div>
                                ...
                                <img src={img12} id="career-image12" className="col-md-4 float-md-start mb-0 me-md-3" alt="image" />
                    ...
                    <div className="container">
                        ...
                        <div className="clearfix" >
                            <div className="career-text">
                                ...
                                <img src={img13} id="career-image13" className="col-md-4 float-md-end mb-1 ms-md-3" alt="image" />
                        ...
                        <img src={graph1} id="career-image14" alt="image" />
