...
import career_img1 from '../image/Einstein_patentoffice.jpg';
import career_img2 from '../image/Einstein-with-habicht-and-solovine.jpg';
import career_img3 from '../image/the newyorktimes.png';
import career_img4 from '../image/Albert_Einstein_(Nobel).png';
import career_img5 from '../image/lossy-page1-440px-League_of_Nations_Commission_067.tif.jpg';
import career_img6 from '../image/1919_eclipse_positive.jpg';
import career_img7 from '../image/MillikanLemaitreEinstein.jpg';
import career_img8 from '../image/Albert_Einstein_photo_1920.jpg';
        ...
        <div>
            <div className="container">
                ...
                <section>
                    ...
                    <h2 className="career-subheading1">1919: Putting general relativity to the test</h2>
                    <div>
                        <img src={career_img3} id="career-image3" className="col-md-3 float-md-start mb-1 me-md-3" alt="image" />
                ...
                <br />
                <section>
                    <h2 className="career-subheading2">1921–1923: Coming to terms with fame</h2>
                    <div className="clearfix">
                        <img src={career_img4} id="career-image4" className="col-md-3 float-md-end mb-2 ms-md-3" alt="image" />
                        <div className="career-text">
                ...
                <section>
                    <div className="clearfix">
                        <h2 className="career-subheading3">1922–1932: Serving the League of Nations</h2>
                        <img src={career_img5} id="career-image5" className="col-md-4 float-md-start mb-1 me-md-3" alt="image" />
                        <div className="career-text">
                ...
                <br />
                <section>
                    <h1 className="career-Header">Scientific career</h1>
                    <hr className="career-hr" />
                    <div className="career-text">
                        <p>
                    ...
                    <h2 className="career-subheading4">1905 – Annus Mirabilis papers</h2>
                    <div className="career-text">
                    ...
                    <div className="text">
                        ...
                        <h5>Hole argument and Entwurf theory</h5>
                        <p>While developing general relativity, Einstein became confused about the gauge invariance in the theory. He formulated an argument that led him to conclude that a general relativistic field theory is impossible. He gave up looking for fully generally covariant tensor equations and searched for equations that would be invariant under general linear transformations only.
                            In June 1913, the Entwurf ('draft') theory was the result of these investigations. As its name suggests, it was a sketch of a theory, less elegant and more difficult than general relativity, with the equations of motion supplemented by additional gauge fixing conditions. After more than two years of intensive work, Einstein realized that the hole argument was mistakenand abandoned the theory in November 1915.</p>
                    ...
                    <div className="text">
                        ...
                        <p>In a series of works completed from 1911 to 1913, Planck reformulated his 1900 quantum theory and introduced the idea of zero-point energy in his "second quantum theory". Soon, this idea attracted the attention of Einstein and his assistant Otto Stern. Assuming the energy of rotating diatomic molecules contains zero-point energy, they then compared the theoretical specific heat of hydrogen gas with the experimental data. The numbers matched nicely. However, after publishing the findings, they promptly withdrew their support, because they no longer had confidence in the correctness of the idea of zero-point energy. </p>
                        <h5>Stimulated emission</h5>
                        <p>In 1917, at the height of his work on relativity, Einstein published an article in Physikalische Zeitschrift that proposed the possibility of stimulated emission, the physical process that makes possible the maser and the laser. This article showed that the statistics of absorption and emission of light would only be consistent with Planck's distribution law if the emission of light into a mode with n photons would be enhanced statistically compared to the emission of light into an empty mode. This paper was enormously influential in the later development of quantum mechanics, because it was the first paper to show that the statistics of atomic transitions had simple laws. </p>
                        <h6>Matter waves</h6>
                        <p>Einstein discovered Louis de Broglie's work and supported his ideas, which were received skeptically at first. In another major paper from this era, Einstein observed that de Broglie waves could explain the quantization rules of Bohr and Sommerfeld. This paper would inspire Schrödinger's work of 1926. </p>
                    ...
                    <div className="clearfix">
                        <div className="text">
                            ...
                            <h5>Bohr versus Einstein</h5>
                            <p>The Bohr–Einstein debates were a series of public disputes about quantum mechanics between Einstein and Niels Bohr, who were two of its founders. Their debates are remembered because of their importance to the philosophy of science. Their debates would influence later interpretations of quantum mechanics.</p>
                    ...
                    <div className="container">
                        ...
                        <h5>Collaboration with other scientists</h5>
